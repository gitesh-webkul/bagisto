                ...
                <div class="col-lg-7 col-md-12">
                    ...
                    <div
                        ...
                        <shipping-section
                            ...
                            @onShippingStorePickupSelected="shippingStorePickupSelected($event)"
            ...
            Vue.component('checkout', {
                ...
                methods: {
                    ...
                    saveShipping: async function () {
                        ...
                        this.$http.post("{{ route('shop.checkout.save-shipping') }}", 
                            {
                    ...
                    placeOrder: async function () {
                        if (this.isPlaceOrderEnabled) {
                            ...
                            this.$http.post("{{ route('shop.checkout.save-order') }}", 
                                {   
                                    '_token': "{{ csrf_token() }}", 
                                    'store_pickup':this.selectedStorePickup,
                                })
                            .then(response => {
                                if (response.data.success) {
                    ...
                    shippingStorePickupSelected: function (shippingStorePickup) {
                        this.selectedStorePickup = shippingStorePickup;
                    },
            ...
            Vue.component('shipping-section', {
                ...
                data: function () {
                    return {
                        ...
                        locationAttr:{
                            current_user_lat:localStorage.getItem("current_user_lat"),
                            current_user_long:localStorage.getItem("current_user_long") 
                        }
                    }
                },
                ...
                methods: {
                    methodSelectedStorePickup:function(event){
                        console.log(event.target.value);
                        this.$emit('onShippingStorePickupSelected', event.target.value);
                    },
                    methodSelected: function () {
                        ...
                        //this.$emit('onShippingMethodSelected', this.selected_shipping_method);
                        var storesThis = this;
                        if( this.selected_shipping_method == "pickup_store_pickup_store"){
                            this.storeLocators = 1;
                            let storesRoutes = "{{ route('pickup-stores.get-stores-list') }}";
                            axios.post(storesRoutes, this.locationAttr)
                            .then(function (response) {
                                if(response.data.status == 200){
                                    storesThis.storesLocatorsArr = response.data.stores;
                                }   
                            }).catch(function (error) {
                                //location.reload();
                            });
                        }else{
                            this.storeLocators = 0;
                            storesThis.storesLocatorsArr = [];
                        }
